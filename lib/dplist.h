...
struct dplist
{
    dplist_node_t * head;                       // the head refers to the starting memory location of the list
    void * (*element_copy)(void * src_element);
    void (*element_free)(void ** element);
    int (*element_compare)(void * x, void * y); // a function pointer called 'element_compare'
};
